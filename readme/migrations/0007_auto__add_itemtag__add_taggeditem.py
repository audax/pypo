...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('readme_itemtag', (
        ...
        db.send_create_signal('readme', ['ItemTag'])

        # Adding model 'TaggedItem'
        db.create_table('readme_taggeditem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['readme.ItemTag'])),
            ('content_object', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['readme.Item'])),
        ))
        db.send_create_signal('readme', ['TaggedItem'])


    def backwards(self, orm):
        # Deleting model 'ItemTag'
        db.delete_table('readme_itemtag')

        # Deleting model 'TaggedItem'
        db.delete_table('readme_taggeditem')
    ...
    models = {
        ...
        'readme.taggeditem': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['readme.ItemTag']"})
        }
    }
