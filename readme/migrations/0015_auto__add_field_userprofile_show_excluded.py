...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.show_excluded'
        db.add_column('readme_userprofile', 'show_excluded',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.show_excluded'
        db.delete_column('readme_userprofile', 'show_excluded')
    ...
    models = {
        ...
        'readme.userprofile': {
            ...
            'show_excluded': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
