...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('readme_userprofile', (
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(primary_key=True, to=orm['auth.User'], unique=True)),
            ('theme', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('can_invite', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('readme', ['UserProfile'])


    def backwards(self, orm):
        # Deleting model 'UserProfile'
        db.delete_table('readme_userprofile')
